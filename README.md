...
| Classification   ★                     |   Comparing ML Classifiers: Model Performance & Decision Boundaries [(sklearn Documentation)](https://scikit-learn.org/stable/supervised_learning.html)                 | [ sklearn Demo](https://github.com/Ausername-Asterisk/Ausername-Asterisk.github.io/blob/main/files/8_Comparing_ML_Classifiers_Model_Performance_%26_Decision_Boundaries_Github.ipynb) |
