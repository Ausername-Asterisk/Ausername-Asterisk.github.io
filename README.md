...
| Classification   ★                     |   Comparing ML Classifiers: Model Performance & Decision Boundaries [(Sklearn Documentationn)](https://scikit-learn.org/stable/supervised_learning.html)                 | [Python (sklearn)](https://github.com/Ausername-Asterisk/Ausername-Asterisk.github.io/blob/main/files/8_Comparing_ML_Classifiers_Model_Performance_%26_Decision_Boundaries_Github.ipynb) |
